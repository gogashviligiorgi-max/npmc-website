...
const conditionData_ru = {
  adhd: {
    title: 'СДВГ',
    subtitle: 'Синдром дефицита внимания и гиперактивности',
    icon: conditionData.adhd.icon,
    description: 'СДВГ (синдром дефицита внимания и гиперактивности) — это нейроонтогенетическое состояние, влияющее на концентрацию, контроль импульсов и уровень физической активности. Встречается как у детей, так и у взрослых. Во многих случаях только медикаментозное лечение даёт лишь частичное облегчение — оно маскирует симптомы, но не меняет базовые паттерны нейронной активности мозга.',
    symptoms: [
      'Трудность удержания фокуса и постоянная отвлекаемость',
      'Импульсивные решения и поступки',
      'Физическая гиперактивность или внутреннее ощущение беспокойства',
      'Проблемы с управлением временем и организацией',
      'Забывчивость и трудности с выполнением повседневных задач'
    ],
    qeeg: [
      { name: 'Theta', hz: '4–8 Гц', status: 'high', desc: 'Избыток активности во фронтальной зоне — классический паттерн СДВГ' },
      { name: 'Beta', hz: '13–30 Гц', status: 'low', desc: 'Дефицит в лобной доле, вызывающий трудности с устойчивым фокусом и концентрацией' },
      { name: 'Alpha', hz: '8–12 Гц', status: 'normal', desc: 'Обычно в пределах нормы; иногда возможна лёгкая асимметрия' },
      { name: 'Delta', hz: '0.5–4 Гц', status: 'high', desc: 'Иногда повышена, что указывает на фронтальную гипоактивацию и сниженную корковую активацию' }
    ],
    treatment: 'Нейробиоуправление — один из наиболее тщательно изученных методов лечения СДВГ, с более чем 50-летней исследовательской базой. ТМС — для усиления фронтальной Beta-активности, повышения ясности ума и когнитивной вовлечённости. Объективное измерение соотношения Theta/Beta через QEEG — для индивидуального, целенаправленного плана терапии.'
  },
  depression: {
    title: 'Депрессия',
    subtitle: 'Клиническая депрессия и резистентные к лечению формы',
    icon: conditionData.depression.icon,
    description: 'Клиническая депрессия — это не просто «плохое настроение», а сложное нарушение биохимии и электрической активности мозга. Традиционный подход (антидепрессанты) помогает лишь примерно 50% пациентов. Для тех, на кого медикаменты не действуют, необходима прямая, целенаправленная коррекция нейронных паттернов мозга.',
    symptoms: [
      'Постоянная грусть, ощущение пустоты и всепроникающее чувство безнадёжности',
      'Потеря интереса к занятиям, которые раньше приносили удовольствие',
      'Заметное снижение энергии и хроническая усталость',
      'Нарушения сна (бессонница или, наоборот, чрезмерная сонливость)',
      'Трудности с концентрацией и принятием решений',
      'Соматические жалобы (необъяснимые боли, тяжесть во всём теле)'
    ],
    qeeg: [
      { name: 'Alpha', hz: '8–12 Гц', status: 'high', desc: 'Асимметрия: избыток активности в правой лобной доле относительно левой — классический неврологический маркер депрессии' },
      { name: 'Theta', hz: '4–8 Гц', status: 'high', desc: 'Повышена в передних зонах — связана с руминацией (навязчивое прокручивание негативных мыслей)' },
      { name: 'Beta', hz: '13–30 Гц', status: 'low', desc: 'Сниженная активность, способствующая дефициту энергии и мотивации' },
      { name: 'Delta', hz: '0.5–4 Гц', status: 'normal', desc: 'Как правило, в пределах нормы, если нет тяжёлых органических нарушений сна' }
    ],
    treatment: 'ТМС — одобренный FDA метод, эффективно воздействующий на резистентную к лечению депрессию. Мы стимулируем левый DLPFC (дорсолатеральная префронтальная кора), чтобы скорректировать альфа-асимметрию. Протокол под контролем QEEG + нейробиоуправление + целенаправленная психотерапия — синергетический подход, который работает там, где другие методы не справились.'
  },
  anxiety: {
    title: 'Тревога',
    subtitle: 'Генерализованное тревожное расстройство (ГТР) и социальная тревога',
    icon: conditionData.anxiety.icon,
    description: 'Тревожные расстройства представляют собой состояние хронической гипервозбудимости мозга. Миндалина («центр страха» мозга) хронически перевозбуждена, а альфа-волновой барьер, отвечающий за спокойствие, ослаблен. В результате человек воспринимает угрозу даже там, где её нет, создавая постоянное внутреннее напряжение.',
    symptoms: [
      'Постоянное, неконтролируемое беспокойство и тревожность',
      'Хроническое мышечное напряжение (особенно в плечах и шее)',
      'Трудности с засыпанием или прерывистый, фрагментарный сон',
      'Физические проявления: учащённое сердцебиение, потливость, дрожь',
      'Трудности с концентрацией и ощущение мысленного «отключения»'
    ],
    qeeg: [
      { name: 'Beta', hz: '13–30 Гц', status: 'high', desc: 'Повышена в лобных и центральных зонах — признак стойкой гипервозбудимости' },
      { name: 'High Beta', hz: '20–30 Гц', status: 'high', desc: 'Избыток активности, вызывающий тревожную мысленную блокировку и когнитивный туман' },
      { name: 'Alpha', hz: '8–12 Гц', status: 'low', desc: 'Дефицит спокойствия; альфа-барьер слаб, и мозг больше не может достичь расслабления' },
      { name: 'Theta', hz: '4–8 Гц', status: 'normal', desc: 'Как правило, в пределах нормы, если тревога не сочетается с другим расстройством' }
    ],
    treatment: 'Нейробиоуправление (Alpha-протокол) — мы тренируем мозг генерировать альфа-волны, повышая устойчивость к стрессу. ТМС — для подавления избыточной бета-активности в лобных зонах. Нормализация соотношения альфа/бета под контролем QEEG — устранение хронической тревоги на неврологическом уровне.'
  },
  panic: {
    title: 'Панические атаки',
    subtitle: 'Острые панические эпизоды и дисрегуляция вегетативной нервной системы',
    icon: conditionData.panic.icon,
    description: 'Паническая атака — это внезапная «перегрузка» системы эмоциональной регуляции мозга. Миндалина (центр тревоги мозга) посылает ложный сигнал угрозы, а лобная кора (рациональный мозг) не успевает его подавить. Человек испытывает ощущение неминуемой физической смерти — это не воображение, а реальный биохимический процесс.',
    symptoms: [
      'Внезапное, интенсивное учащённое сердцебиение',
      'Одышка и ощущение нехватки воздуха',
      'Давление или боль в области груди',
      'Головокружение и чувство нереальности (дереализация)',
      'Всепоглощающий страх смерти или «потери рассудка»'
    ],
    qeeg: [
      { name: 'High Beta', hz: '20–30 Гц', status: 'high', desc: 'Миндалина в состоянии гиперактивации, непрерывно генерирует сигналы «тревоги»' },
      { name: 'Alpha', hz: '8–12 Гц', status: 'low', desc: 'Ресурсы спокойствия заблокированы; фронтальный регуляторный контроль ослаблен' },
      { name: 'Theta', hz: '4–8 Гц', status: 'high', desc: 'Иногда повышена в зонах проекции миндалины — отражает эмоциональную нестабильность' },
      { name: 'Beta', hz: '13–20 Гц', status: 'high', desc: 'Избыток активности, поддерживающий состояние стойкой гипервозбудимости' }
    ],
    treatment: 'ТМС — усиливает альфа-волны и снижает активность High Beta («тревога»); помогает мозгу восстановить регуляторный контроль. Нейробиоуправление (Alpha-Theta протокол) — нейронная тренировка глубокого расслабления; пациенты учатся переходить из состояния тревоги в состояние спокойствия. QEEG — объективное измерение прогресса на каждом сеансе.'
  },
  ocd: {
    title: 'ОКР',
    subtitle: 'Обсессивно-компульсивное расстройство',
    icon: conditionData.ocd.icon,
    description: 'ОКР характеризуется гиперактивностью фронто-стриато-таламического контура мозга. Навязчивые мысли создают специфический паттерн «зацикливания» в мозге, который пациент не может прервать одной лишь волей — мозг оказывается в ловушке одного и того же повторяющегося цикла. ТМС сегодня — один из наиболее изученных и одобренных FDA методов лечения ОКР.',
    symptoms: [
      'Повторяющиеся, неконтролируемые навязчивые мысли (обсессии)',
      'Компульсивное поведение или ритуалы (компульсии)',
      'Чрезмерное стремление к симметрии, чистоте и контролю',
      'Сильная тревога, когда ритуал по какой-либо причине невозможно завершить',
      'Значительное ухудшение повседневного функционирования и качества жизни'
    ],
    qeeg: [
      { name: 'Beta', hz: '13–30 Гц', status: 'high', desc: 'Избыток активности во фронто-центральных зонах — отражает обсессивно-компульсивный цикл' },
      { name: 'Theta', hz: '4–8 Гц', status: 'high', desc: 'Повышенные показатели указывают на «застревание» навязчивых мыслей в фиксированной петле' },
      { name: 'Alpha', hz: '8–12 Гц', status: 'low', desc: 'Дефицит спокойствия; пациентам трудно «отпускать» мысли и переключать внимание' },
      { name: 'Gamma', hz: '30–100 Гц', status: 'high', desc: 'Гиперсинхрония: избыток активности в базальных ганглиях и лобных сетях' }
    ],
    treatment: 'ТМС (одобрено FDA) — стимуляция SMA (дополнительная моторная область) снижает компульсивное поведение и стремление выполнять ритуалы. Нейробиоуправление — усиление альфа помогает мозгу обрести свободу от навязчивых мыслей. Анализ когерентности QEEG — точное картирование межрегиональной синхронности с определением мишеней стимуляции с миллиметровой точностью.'
  },
  sleep: {
    title: 'Проблемы со сном',
    subtitle: 'Бессонница, хроническая усталость и ухудшение качества сна',
    icon: conditionData.sleep.icon,
    description: 'Проблемы со сном часто являются результатом дисбаланса электрических паттернов мозга — а не просто стресса или плохих привычек. Когда дельта-волны в дефиците на стадиях глубокого сна, а бета-активность избыточна ночью, мозг не может «отключиться» и восстановиться. Возникает состояние, при котором тело физически отдыхает, но мозг продолжает работать.',
    symptoms: [
      'Трудности с засыпанием и наплыв мыслей перед сном',
      'Частые пробуждения в течение ночи',
      'Поверхностный, невосстанавливающий сон и раннее пробуждение',
      'Пробуждение с чувством истощения и усталости',
      'Хроническая дневная слабость и стойкий мысленный туман (Brain Fog)'
    ],
    qeeg: [
      { name: 'Beta', hz: '13–30 Гц', status: 'high', desc: 'Повышенная фронтальная активность — «активный» мозг, не способный перейти в состояние покоя' },
      { name: 'Delta', hz: '0.5–4 Гц', status: 'low', desc: 'Дефицит указывает на недостаточность стадий глубокого сна и невозможность полного восстановления' },
      { name: 'Alpha', hz: '8–12 Гц', status: 'low', desc: 'Слабость альфа-дельта-барьера делает сон поверхностным и легко прерываемым' },
      { name: 'Theta', hz: '4–8 Гц', status: 'normal', desc: 'Часто в пределах нормы, хотя её снижение может ухудшать переход в гипнагогический сон' }
    ],
    treatment: 'Нейробиоуправление (Delta/Theta протокол) — укрепляет волновую активность, отвечающую за глубокий сон. Alpha-Theta тренинг — нейронное обучение глубокому расслаблению, способствующее спокойному засыпанию. ТМС — снижает избыточную ночную бета-активность, «отключая» лишний мысленный шум. PEMF-терапия — импульсное электромагнитное поле способствует клеточному расслаблению и восстановлению.'
  },
  ptsd: {
    title: 'ПТСР и травма',
    subtitle: 'Посттравматическое стрессовое расстройство',
    icon: conditionData.ptsd.icon,
    description: 'ПТСР — это состояние, при котором после травмирующего события мозг «застревает» в режиме обнаружения угрозы. Миндалина (центр тревоги) хронически гиперактивна, а гиппокамп (центр памяти) ослаблен. В результате травматическое воспоминание не может быть правильно интегрировано, и человек продолжает переживать его снова и снова. Это биологический процесс и структурное изменение мозга — оно не связано с силой воли или характером.',
    symptoms: [
      '<strong>Вторжение:</strong> флешбэки (повторное переживание события) и повторяющиеся кошмары',
      '<strong>Гипервозбудимость:</strong> постоянное напряжение и преувеличенная реакция вздрагивания на внезапные стимулы',
      '<strong>Эмоциональное оцепенение:</strong> ощущение «застывания» и социальная отстранённость',
      '<strong>Ангедония:</strong> утрата способности испытывать радость и удовольствие',
      '<strong>Избегание:</strong> намеренное избегание мест или воспоминаний, связанных с травмой'
    ],
    qeeg: [
      { name: 'Alpha', hz: '8–12 Гц', status: 'low', desc: 'Асимметрия: правая гипоактивность и перегрузка левого полушария — классическая неврологическая картина травмы' },
      { name: 'Theta', hz: '4–8 Гц', status: 'high', desc: 'Избыток активности, лежащий в основе «застревания» травматических воспоминаний и их постоянного переигрывания' },
      { name: 'High Beta', hz: '20–30 Гц', status: 'high', desc: 'Хроническая гипервозбудимость — мозг постоянно настороже, ожидая угрозы' },
      { name: 'Delta', hz: '0.5–4 Гц', status: 'normal', desc: 'Как правило, в пределах нормы, хотя возможны нарушения на стадиях глубокого сна' }
    ],
    treatment: 'Нейробиоуправление (Alpha-Theta протокол) — один из наиболее признанных методов лечения ПТСР; помогает мозгу безопасно переработать травматические воспоминания и достичь глубокого неврологического расслабления. EMDR + психотерапия под контролем QEEG — в сочетании с данными карты мозга терапия становится целенаправленной и точной. ТМС — корректирует альфа-асимметрию и восстанавливает эмоциональную регуляцию. Комплексная программа — устранение всех структурных нарушений одновременно для устойчивого, долгосрочного результата.'
  },
  phobia: {
    title: 'Фобии',
    subtitle: 'Специфические и социальные фобии — нейробиологическая основа системы страха',
    icon: conditionData.phobia.icon,
    description: 'Фобия — это не просто страх, а гиперреактивность миндалины (центра страха мозга) на определённый стимул. Это «ошибочное научение» закодировано на нейронном уровне, поэтому лобная кора (рациональный мозг) не может логически подавить реакцию страха. Картирование QEEG точно выявляет, где именно в мозге происходит эта бессознательная гиперреактивность.',
    symptoms: [
      'Интенсивный, неконтролируемый страх в ответ на определённый объект или ситуацию',
      'Избегающее поведение — уклонение от контакта с провоцирующим стимулом любой ценой',
      'Осознание того, что страх иррационален, но неспособность его преодолеть',
      'Физические признаки паники при столкновении — потливость, дрожь, учащённое дыхание',
      'Значительное ограничение повседневной жизни и социальной активности'
    ],
    qeeg: [
      { name: 'High Beta', hz: '20–30 Гц', status: 'high', desc: 'Избыток активности во фронто-амигдалярной сети — системная гиперчувствительность' },
      { name: 'Alpha', hz: '8–12 Гц', status: 'low', desc: 'Ресурсы спокойствия заблокированы; фронтальный тормозной механизм ослаблен' },
      { name: 'Theta', hz: '4–8 Гц', status: 'high', desc: 'Иногда повышена — отражает глубоко закодированную структуру эмоциональной памяти страха' },
      { name: 'Beta', hz: '13–20 Гц', status: 'high', desc: 'Повышена — гиперактивность, связанная с условными (выученными) реакциями тревоги' }
    ],
    treatment: 'Нейробиоуправление (усиление Alpha) — тренировка тормозной системы мозга; мозг учится сохранять спокойствие в присутствии ранее пугающих стимулов. ТМС — нормализует связность миндалины и лобной коры, восстанавливая рациональный контроль мозга над реакциями страха. Экспозиционная терапия под контролем QEEG — с объективным мониторингом физиологической реакции пациента, для безопасного и эффективного терапевтического процесса.'
  }
};

function openConditionModal(key) {
  const lang = document.documentElement.lang;
  const d = (lang === 'ru' && conditionData_ru[key]) ? conditionData_ru[key]
          : (lang === 'en' && conditionData_en[key]) ? conditionData_en[key]
          : conditionData[key];
  if (!d) return;

  const isEn = lang === 'en';
  const LBL = {
    ka: { high: '↑ მომატებული', low: '↓ შემცირებული', normal: '✓ ნორმა', whatIs: 'რა არის?', symptoms: 'ძირითადი სიმპტომები', qeeg: 'QEEG სურათი — ტვინში რას ვხედავთ', treatment: 'მკურნალობა NPMC-ში', book: 'დაჯავშნე კონსულტაცია', pricing: 'ნახე ფასები' },
    en: { high: '↑ Elevated', low: '↓ Reduced', normal: '✓ Normal', whatIs: 'What is it?', symptoms: 'Key Symptoms', qeeg: 'QEEG Profile — What We See in the Brain', treatment: 'Treatment at NPMC', book: 'Book a Consultation', pricing: 'View Pricing' },
    ru: { high: '↑ Повышено', low: '↓ Понижено', normal: '✓ Норма', whatIs: 'Что это?', symptoms: 'Основные симптомы', qeeg: 'Профиль QEEG — что мы видим в мозге', treatment: 'Лечение в NPMC', book: 'Записаться на консультацию', pricing: 'Посмотреть цены' },
  };
  const lbl = LBL[lang] || LBL.ka;
  ...
  const BRAIN_MAP_CONFIG_RU = {
    adhd:       { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff2200,#ff8800)', label: 'Theta ↑ Фронтальный' },
      { grad: 'linear-gradient(90deg,#ffdd00,#00ee88)', label: 'Норма' },
      { grad: 'linear-gradient(90deg,#0088ff,#0044cc)', label: 'Beta ↓ Париет./Окципит.' },
    ]},
    depression: { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff2200,#ff8800)', label: 'Alpha ↑ Правый фронт. (асимметрия)' },
      { grad: 'linear-gradient(90deg,#ffdd00,#44cc88)', label: 'Левый фронт. / Центр.' },
      { grad: 'linear-gradient(90deg,#0088ff,#0044cc)', label: 'Beta ↓ Париет./Окципит.' },
    ]},
    anxiety:    { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff2200,#ff6600)', label: 'Beta/High Beta ↑ Фронт./Центр.' },
      { grad: 'linear-gradient(90deg,#ffcc00,#ffee44)', label: 'Темпор./Париет. — повышено' },
      { grad: 'linear-gradient(90deg,#0066ff,#0044cc)', label: 'Alpha ↓ — дефицит спокойствия' },
    ]},
    panic:      { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff0000,#ff4400)', label: 'High Beta ↑ Фронт. + Темпор. (амигд.)' },
      { grad: 'linear-gradient(90deg,#ff8800,#ffcc00)', label: 'Beta ↑ Центр./Париет.' },
      { grad: 'linear-gradient(90deg,#0055ff,#0033cc)', label: 'Alpha ↓ заблокирован' },
    ]},
    ocd:        { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff2200,#ff6600)', label: 'Beta+Theta ↑ Мед. фронт./SMA (цикл)' },
      { grad: 'linear-gradient(90deg,#ff9900,#ffcc00)', label: 'Лат. фронт./центр. — повышено' },
      { grad: 'linear-gradient(90deg,#0066ff,#0044cc)', label: 'Alpha ↓ — трудность «отпускания»' },
    ]},
    sleep:      { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff3300,#ff7700)', label: 'Beta ↑ Фронт. — «активный» мозг' },
      { grad: 'linear-gradient(90deg,#ffaa00,#ffdd44)', label: 'Центр./Темпор. — умеренно' },
      { grad: 'linear-gradient(90deg,#0044ff,#002299)', label: 'Delta+Alpha ↓ Париет./Окципит.' },
    ]},
    ptsd:       { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff2200,#ff6600)', label: 'High Beta ↑ Билат. фронт. — гипервозбудимость' },
      { grad: 'linear-gradient(90deg,#ff8800,#ffcc00)', label: 'Theta ↑ Темпор./Центр. — травматический цикл' },
      { grad: 'linear-gradient(90deg,#0055ff,#0033bb)', label: 'Alpha ↓ Правый париет./окципит. — асимметрия' },
    ]},
    phobia:     { canvasId: 'conditionBrainMap', legend: [
      { grad: 'linear-gradient(90deg,#ff0000,#ff5500)', label: 'High Beta ↑ Темпор. (амигд.) + Фронт.' },
      { grad: 'linear-gradient(90deg,#ff8800,#ffcc00)', label: 'Beta ↑ Центр. — условная тревога' },
      { grad: 'linear-gradient(90deg,#0066ff,#0033cc)', label: 'Alpha ↓ — тормозной механизм заблокирован' },
    ]},
  };
  ...
  const bmCfgMap = lang === 'ru' ? BRAIN_MAP_CONFIG_RU : isEn ? BRAIN_MAP_CONFIG_EN : BRAIN_MAP_CONFIG;
...
const CONDITION_BRAIN_PARAMS = {
  ...
  panic_after: {
    /* High Beta frontal & temporal calmed; posterior Alpha fully recovered */
    Fp1:[0.52,0.02,0.04,0.02,0.00], Fp2:[0.51,0.02,0.04,0.02,0.30],
    F7: [0.50,0.02,0.04,0.02,0.65], F3: [0.53,0.02,0.04,0.02,1.05],
    Fz: [0.54,0.02,0.04,0.02,1.45], F4: [0.53,0.02,0.04,0.02,1.85],
    F8: [0.50,0.02,0.04,0.02,2.25],
    T3: [0.51,0.02,0.04,0.02,2.65], C3: [0.53,0.02,0.04,0.02,3.05],
    Cz: [0.54,0.02,0.04,0.02,3.45], C4: [0.52,0.02,0.04,0.02,3.85],
    T4: [0.51,0.02,0.04,0.02,4.25],
    T5: [0.59,0.02,0.03,0.02,4.65], P3: [0.63,0.01,0.03,0.02,5.05],
    Pz: [0.65,0.01,0.03,0.02,5.45], P4: [0.63,0.01,0.03,0.02,5.85],
    T6: [0.58,0.02,0.03,0.02,6.25],
    O1: [0.67,0.01,0.03,0.02,0.05], O2: [0.68,0.01,0.03,0.02,0.45],
  },
  ocd_after: {
    /* Medial frontal (Fz) & central loop calmed; Alpha-Gamma normalised */
    Fp1:[0.51,0.02,0.04,0.02,0.00], Fp2:[0.51,0.02,0.04,0.02,0.30],
    F7: [0.50,0.02,0.04,0.02,0.65], F3: [0.52,0.02,0.04,0.02,1.05],
    Fz: [0.52,0.02,0.04,0.02,1.45], F4: [0.52,0.02,0.04,0.02,1.85],
    F8: [0.50,0.02,0.04,0.02,2.25],
    T3: [0.49,0.02,0.04,0.02,2.65], C3: [0.52,0.02,0.04,0.02,3.05],
    Cz: [0.53,0.02,0.04,0.02,3.45], C4: [0.52,0.02,0.04,0.02,3.85],
    T4: [0.49,0.02,0.04,0.02,4.25],
    T5: [0.58,0.02,0.03,0.02,4.65], P3: [0.62,0.01,0.03,0.02,5.05],
    Pz: [0.64,0.01,0.03,0.02,5.45], P4: [0.62,0.01,0.03,0.02,5.85],
    T6: [0.57,0.02,0.03,0.02,6.25],
    O1: [0.66,0.01,0.03,0.02,0.05], O2: [0.67,0.01,0.03,0.02,0.45],
  },
  ptsd_after: {
    /* Bilateral frontal hypervigilance resolved; Alpha asymmetry corrected */
    Fp1:[0.52,0.02,0.04,0.02,0.00], Fp2:[0.52,0.02,0.04,0.02,0.35],
    F7: [0.50,0.02,0.04,0.02,0.70], F3: [0.53,0.02,0.04,0.02,1.10],
    Fz: [0.54,0.02,0.04,0.02,1.50], F4: [0.53,0.02,0.04,0.02,1.90],
    F8: [0.51,0.02,0.04,0.02,2.30],
    T3: [0.51,0.02,0.04,0.02,2.70], C3: [0.53,0.02,0.04,0.02,3.10],
    Cz: [0.54,0.02,0.04,0.02,3.50], C4: [0.53,0.02,0.04,0.02,3.90],
    T4: [0.51,0.02,0.04,0.02,4.30],
    T5: [0.59,0.02,0.03,0.02,4.70], P3: [0.62,0.01,0.03,0.02,5.10],
    Pz: [0.64,0.01,0.03,0.02,5.50], P4: [0.64,0.01,0.03,0.02,5.90],
    T6: [0.60,0.02,0.03,0.02,6.30],
    O1: [0.65,0.01,0.03,0.02,0.10], O2: [0.66,0.01,0.03,0.02,0.50],
  },
  phobia_after: {
    /* Amygdala (T3/T4) dramatically calmed; frontal balanced; Alpha recovered */
    Fp1:[0.51,0.02,0.04,0.02,0.00], Fp2:[0.51,0.02,0.04,0.02,0.35],
    F7: [0.50,0.02,0.04,0.02,0.70], F3: [0.52,0.02,0.04,0.02,1.10],
    Fz: [0.53,0.02,0.04,0.02,1.50], F4: [0.52,0.02,0.04,0.02,1.90],
    F8: [0.50,0.02,0.04,0.02,2.30],
    T3: [0.51,0.02,0.04,0.02,2.70], C3: [0.53,0.02,0.04,0.02,3.10],
    Cz: [0.54,0.02,0.04,0.02,3.50], C4: [0.52,0.02,0.04,0.02,3.90],
    T4: [0.51,0.02,0.04,0.02,4.30],
    T5: [0.58,0.02,0.03,0.02,4.70], P3: [0.62,0.01,0.03,0.02,5.10],
    Pz: [0.64,0.01,0.03,0.02,5.50], P4: [0.63,0.01,0.03,0.02,5.90],
    T6: [0.57,0.02,0.03,0.02,6.30],
    O1: [0.67,0.01,0.03,0.02,0.10], O2: [0.68,0.01,0.03,0.02,0.50],
  },
};
...
(function () {
  ...
  const NOTES = {
    ...
    panic:      'Extreme High Beta ↑↑ ფრონტ. + T3/T4 (ამიგდალა) — "განგაშის" რეჟიმი. Alpha-Theta training + TMS ამშვიდებს.',
    ocd:        'Fz/Cz ჰიპერ-სინქრონია (ფრონტო-სტრიატო-თალ. წრედი) — ობსეს. ციკლი. TMS SMA + ნეიროფიდბექი ჭრის წრეს.',
